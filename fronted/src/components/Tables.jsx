                                ...
                                <div key={subIndex} className="subItem">{subItem}
                                  {(role === "Director" && props.uri === "profesores") ?
                                    ...
                                    role === "Profesor" && props.uri === "actividades" ?
                                      <svg onClick={() => handleDesAsing(item.Clase.indexOf(subItem) + 1, item.Clase)} xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-journal-minus searchsvg" viewBox="0 0 16 16" >
